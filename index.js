...
const dkimDomain = 'go-mail.us.to'; // Your DKIM domain
const dkimSelector = 'default'; // Your DKIM selector

async function sendEmailToMx(domain, from, to, subject, text) {
    try {
        // Fetch MX records
        ...
        // Create a RFC822 message
        const rfc822Message = `From: ${from}\r\nTo: ${to}\r\nSubject: ${subject}\r\nDate: ${date}\r\nMessage-ID: ${messageId}\r\n\r\n${text}`;
        ...
        const signature = DKIMSign(rfc822Message, dkimOptions);
...
// Example usage
sendEmailToMx('gmail.com', 'sender@go-mail.us.to', 'sujoyk211@gmail.com', 'Hello', 'Hello world!');
  });
};
RunMainCode();
